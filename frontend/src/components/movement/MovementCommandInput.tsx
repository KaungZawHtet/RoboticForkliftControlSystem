        ...
        <Alert variant="info">
          ...
          <div>
            ...
            <ul className="text-sm space-y-1">
              <li><strong>F[number]</strong> - Move Forward (metres)</li>
              <li><strong>B[number]</strong> - Move Backward (metres)</li>
              <li><strong>L[degrees]</strong> - Turn Left (90, 180, 270, 360)</li>
              <li><strong>R[degrees]</strong> - Turn Right (90, 180, 270, 360)</li>
            </ul>
          </div>
        </Alert>
              ...
              <div className="mb-3">
                ...
                <div className="space-y-1">
                  {result.commands.map((cmd, index) => (
                    <div key={index} className="text-sm text-gray-600 bg-green-50 p-2 rounded flex items-center">
